'''Модуль os
Модуль os предоставляет множество функций для работы с ОС, причем их поведение, 
...
полезные функции для работы с путями, таким как:
os.path.basename(path) - базовое имя пути
        import os
        print(os.path.basename('C:/Users/.../main.py'))  # 'main.py'
os.path.abspath(path) - возвращает нормализованный абсолютный путь
        import os
        print(os.path.abspath('main.py'))  # 'C:/Users/.../main.py
