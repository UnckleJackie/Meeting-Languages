...
public class InstanceMethWithObjectRefDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Days count when was a temperature 89 degrees: " + count);
        ...
        System.out.println("Days count when was a temperature 12 degrees: " + count);
        count = counter(weekDayHighs2, HighTemp::lessThanTemp, new HighTemp(19));
        System.out.println("Days count when was a temperature 19 degrees: " + count);
    }
}
