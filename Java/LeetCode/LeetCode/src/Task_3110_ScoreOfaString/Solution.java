package Task_3110_ScoreOfaString;

/**@apiNote https://leetcode.com/problems/score-of-a-string/description/
 * You are given a string s. The score of a string is defined as the sum
 * of the absolute difference between the ASCII values of adjacent characters.
