...
namespace _008_Windows_Forms
{
    class FormWithManyControls : Form
    {
        ...
        ListBox listBox1;
        public FormWithManyControls() // Метод-конструктор нашего класса
        {
            this.Text = "Форма, включающая различные элементы управления"; // Указываем размеры и заголовок окна
            this.Height = 800; this.Width = 900; // Добавляем элемент TreeView в качестве своеобразного меню

            treeView1 = new TreeView();
            treeView1.BackColor = Color.BurlyWood;
            treeView1.DockStyle.Left;
            treeView1.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(treeView1_AfterSelect);

            TreeNide tn = new TreeNode("Элементы");
            tn.Expand();
            ...
            (object sender, System.Windows.Forms.TreeViewEventArgs e)
        {
            ...
            else if (e.Node.Text == "Button")
            {
                ...
                button1.Text = "Press me, mazafaka!";
            ...
            else if (e.Node.Text == "CheckBox")
            {
                ...
                checkBox2.Text = "Я скромный шо пистец!";
            ...
            else if (e.Node.Text == "RadioButton")
            {
                ...
                radioButton1.Text = "Я добрый ипать!";
                ...
                radioButton2.Text = "Я трудолюбивый ахуеть!";
            ...
            else if (e.Node.Text == "TextBox")
            {
                ...
                textBox1.Text = "Это текстовое окно. Сюда можно вводить текст!" +
                    "\r\n" + "Сотри этот текст и введи свой, Мазафака!";
            ...
            {
                // Добавляем на панель элемент управления вкладками и наполняем каждую вкладку содержимым
                ...
                pictureBox1.Image = new Bitmap("C://Дядя Женя//Деньги//Цели//01 Вопросы.JPG");
                ...
                labelC.Text = "Это компьютер Вадика! " +
                    "Пока Вадик купается, он разрешает работать на компьютере ящерице!";
                ...
                labelT.Text = "Это страна Компьютерия! " +
                    "Она расположена на берегу Тверца в Тверской области!";
            ...
            else if(e.Node.Text == "RichTextBox")
            {
                ...
                richTextBox1.LoadFile("", RichTextBoxStreamType.UnicodePlainText);
            ...
            else if (e.Node.Text == "MainMenu")
            {
                ...
                MessageBox.Show("Главное меню добавлено в окно. Испытайте его после нажатия ОК.");
            }
            else if (e.Node.Text == "ToolBar")
            {
                ...
                imageList1.Images.Add(new Bitmap(""));
                imageList1.Images.Add(new Bitmap(""));
                imageList1.Images.Add(new Bitmap(""));
        ...
        {
            MessageBox.Show("Да, у меток тоже есть событие Click. " +
                "Но для них включение событий - редкость.");
        }
        ...
        void CheckBox_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox("Ни скромности, ни таланта?");
            }
        }
        ...
        {
            TreeView.DefaultBackColor = Color.White;
        }
        // Обработчик события, срабатывающий при выборе в меню цвета
        void mainMenu_ColorOwn_Select(object sender, System.EventArgs e)
        {
